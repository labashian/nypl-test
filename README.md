...
With more time, I would give the user more control over how they would like to split the percentiles. I would also consider a more advanced algorithm/ calculation than just risk based on elevation, as there are obviously many other variables like distance from coast, elevation relative to surroundings, etc., that can factor into flooding risk. 
